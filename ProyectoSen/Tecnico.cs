...
namespace ProyectoSen
{
    public partial class Tecnico : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
           ...
           /* if(txtNombre.Text == "")
            {
                MessageBox.Show("Ingrese el Nombre", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            if (txtApellido.Text == "")
            {
                MessageBox.Show("Ingrese el Apellido", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            if (txtDni.Text == "")
            {
                MessageBox.Show("Ingrese el DNI", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            if (txtTelefono.Text == "")
            {
                MessageBox.Show("Ingrese el Telefono", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            if (txtCargo.Text == "")
            {
                MessageBox.Show("Ingrese el Cargo", "Alerta", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }*/
            else
            {
